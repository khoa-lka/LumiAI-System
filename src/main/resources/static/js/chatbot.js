(function () {
  ...
  function appendLasChatMessage(text, fromUser) {
    const zone = document.getElementById("las-chat-messages-zone");
  ...
  window.sendChatMessageToServer = async function () {
    ...
    const loadingMessage = appendLasChatMessage("LAS đang suy nghĩ...", false);
    ...
    try {
      ...
      const reply = result.reply || "Tôi chưa có câu trả lời.";
